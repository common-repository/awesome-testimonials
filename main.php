...
function pra_install()
{
	...
	$wpdb->query("INSERT INTO $table2 (id,metaname, value)
	VALUES (12,'easing','easing' )");

	$wpdb->query("INSERT INTO $table2 (id,metaname, value)
	VALUES (13,'progress','no' )");
	
	$wpdb->query("INSERT INTO $table2 (id,metaname, value)
	VALUES (14,'progressbarcolor','#ffffff' )");
...
add_action("admin_init", "admin_init");
    ...
    function admin_init(){
        add_meta_box("pra_testimonials_ratings", "Star Ratings", "meta_options", "pra_testimonials", "advanced", "low");
